...
namespace Cogito.IO
{
    ...
    /// <summary>
    /// This class wraps <see cref="FileSystemEventArgs"/> and <see cref="RenamedEventArgs"/> objects and detection of duplicate events.
    /// </summary>
    class DelayedEvent
    {

        readonly FileSystemEventArgs _args;
        ...
        public virtual bool IsDuplicate(object obj)
        {
            ...
            return
                ((eO1 != null && eO2 != null && eO1.ChangeType == eO2.ChangeType && eO1.FullPath == eO2.FullPath && eO1.Name == eO2.Name) &&
                ((reO1 == null & reO2 == null) || (reO1 != null && reO2 != null && reO1.OldFullPath == reO2.OldFullPath && reO1.OldName == reO2.OldName))) ||
                (eO1 != null && eO2 != null && eO1.ChangeType == WatcherChangeTypes.Created && eO2.ChangeType == WatcherChangeTypes.Changed && eO1.FullPath == eO2.FullPath && eO1.Name == eO2.Name);
        }
    }
    ...
    public class DelayedFileSystemWatcher
    {
        ...
        object _enterThread = new object(); // Only one timer event is processed at any given moment
        ArrayList _events = null;

        System.Timers.Timer _serverTimer = null;
        int _msConsolidationInterval = 1000; // milliseconds
