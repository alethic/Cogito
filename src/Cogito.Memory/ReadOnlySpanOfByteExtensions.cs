                ...
                while (o.Length >= 32)
                {
                    ...
                    unsafe
                    {
                        ...
                        fixed (ulong* op = ol)
                        {
                            ...
                            var ov = System.Runtime.Intrinsics.X86.Avx2.And(av, bv);
                ...
                while (o.Length >= 16)
                {
                    ...
                    unsafe
                    {
                        ...
                        fixed (ulong* op = ol)
                        {
                            ...
                            var ov = System.Runtime.Intrinsics.X86.Sse2.And(av, bv);
                ...
                while (o.Length >= 16)
                {
                    ...
                    unsafe
                    {
                        ...
                        fixed (ulong* op = ol)
                        {
                            ...
                            var ov = System.Runtime.Intrinsics.Arm.AdvSimd.And(av, bv);
