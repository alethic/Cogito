...
namespace Cogito.Activities
{
    ...
    public static partial class Expressions
    {
        ...
        /// <param name="body"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Activity<IEnumerable<TElement>> source, ActivityAction<TElement> body)
        {
            Contract.Requires<ArgumentNullException>(source != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="body"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Activity<IEnumerable<TElement>> source, Action<TElement> body)
        {
            Contract.Requires<ArgumentNullException>(source != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="body"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Activity<IEnumerable<TElement>> source, Func<TElement, Task> body)
        {
            Contract.Requires<ArgumentNullException>(source != null);
            Contract.Requires<ArgumentNullException>(body != null);
