...
namespace Cogito.Activities
{
    ...
    public static partial class Expressions
    {
        ...
        /// <param name="body"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(DelegateInArgument<IEnumerable<TElement>> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(DelegateInArgument<TElement[]> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="body"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(InArgument<IEnumerable<TElement>> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(InArgument<TElement[]> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(this Activity<IEnumerable<TElement>> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<IEnumerable<TElement>> values, Func<DelegateInArgument<TElement>, Activity> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<IEnumerable<TElement>> values, ActivityAction<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<IEnumerable<TElement>> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<IEnumerable<TElement>> values, Func<TElement, Task> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<Task<IEnumerable<TElement>>> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(this Activity<TElement[]> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<TElement[]> values, Func<DelegateInArgument<TElement>, Activity> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<TElement[]> values, ActivityAction<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<TElement[]> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<TElement[]> values, Func<TElement, Task> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
        ...
        /// <param name="displayName"></param>
        /// <returns></returns>
        public static ForEach<TElement> ForEach<TElement>(Func<Task<TElement[]>> values, Action<TElement> body, string displayName = null)
        {
            Contract.Requires<ArgumentNullException>(values != null);
            Contract.Requires<ArgumentNullException>(body != null);
