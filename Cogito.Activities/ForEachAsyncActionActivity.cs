...
namespace Cogito.Activities
{
    ...
    public static partial class Activities
    {
        ...
        {
            return new ForEachAsyncActionActivity<TElement>(source, (arg, context) => action(arg));
        }

        public static ForEachAsyncActionActivity<TElement> ForEach<TElement>(InArgument<IEnumerable<TElement>> source, Func<TElement, ActivityContext, Task> action)
        {
        ...
        {
            return new ForEachAsyncActionActivity<TElement>(Invoke(source, i => i.AsEnumerable()), (arg, context) => action(arg));
        }

        public static ForEachAsyncActionActivity<TElement> ForEach<TElement>(InArgument<TElement[]> source, Func<TElement, ActivityContext, Task> action)
        {
        ...
        {
            return new ForEachAsyncActionActivity<TElement>(Invoke(source), (arg, context) => action(arg));
        }

        public static ForEachAsyncActionActivity<TElement> ForEach<TElement>(Func<IEnumerable<TElement>> source, Func<TElement, ActivityContext, Task> action)
        {
        ...
        public static ForEachAsyncActionActivity<TElement> ForEach<TElement>(this Activity<IEnumerable<TElement>> source, Func<TElement, ActivityContext, Task> action)
        {
            return new ForEachAsyncActionActivity<TElement>(source, action);
        }
        ...
        NativeActivity<TElement>
    {
        ...
        public ForEachAsyncActionActivity(InArgument<IEnumerable<TElement>> source, Func<TElement, ActivityContext, Task> action)
        {
            Source = source;
            Action = action;
        }
